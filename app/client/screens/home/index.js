            ...
            <View style={styles.mainContainer}>
                <View style={styles.topBar}>
                        ...
                        <Svg width='100%' height= '100%' viewBox="0 0 92.83 89.33"> 
                            <Path d="M89.83,0H3A3,3,0,0,0,0,3V16.33a3,3,0,0,0,3,3H89.83a3,3,0,0,0,3-3V3A3,3,0,0,0,89.83,0Z" fill="#000000"/>
                            <Path d="M89.83,35H3a3,3,0,0,0-3,3V51.33a3,3,0,0,0,3,3H89.83a3,3,0,0,0,3-3V38A3,3,0,0,0,89.83,35Z" fill="#000000"/>
                            <Path d="M89.83,70H3a3,3,0,0,0-3,3V86.33a3,3,0,0,0,3,3H89.83a3,3,0,0,0,3-3V73A3,3,0,0,0,89.83,70Z" fill="#000000"/>
                        </Svg>
                        </TouchableOpacity>
